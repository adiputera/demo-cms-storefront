 ...
 */
public class CurrencyFormatter implements CmsFormatter {

    /**
     * Formats a numeric value into a map containing the raw value and its USD formatted representation.
     *
